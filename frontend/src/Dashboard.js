      ...
      alert('This time slot is already booked!');
        ...
        handleOpen(true)
          ...
          const PostBooking =() => {
            ...
            const res =axios.post(`/booking/${user_id}`, {...event1,title : `${title} requested by ${userInfo[0].name}`, resource:userInfo[0]._id, allDay:isChecked, cabin_info:cabinId})
                            ...
                            <Typography id="modal-modal-title" variant="h6" component="h2">
                                <form className='m-0 p-0'>
                                   ...
                                   <div className='row mt-3'>
                                    ...
                                    <label for="startDate " className="fs-6">Date</label>
                                    <input  onChange={handleEventEditInput} name="date" id="startDate" class="form-control" type="date" />
                                    </div>
                                    <div className='col-12 col-lg-4'>

                                    <label for="startDate " className="fs-6">Start Time</label>
                                    <input 
                                    ...
                                    <label for="startDate " className="fs-6">End Time</label>
                                    <input 
